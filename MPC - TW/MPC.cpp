...
class FG_eval {
 public:
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
    ...
    for (int t = 0; t < N; t++) {
      fg[0] += 2300*CppAD::pow(vars[cte_start + t]- ref_cte, 2);
      fg[0] += 2300*CppAD::pow(vars[epsi_start + t]- ref_epsi, 2);
...
// set to big and small values until start
